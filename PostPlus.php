...
final class Post_Plus_Extension {
	...
	public function init() {
		...
		// Add Plugin actions
		add_action('elementor/elements/categories_registered', [$this, 'custom_widget_categories']);
	...
	public function custom_widget_categories($elements_manager){
		$elements_manager->add_category(
			'post-plus-cat',
			[
				'title'	=> __('Post Plus', 'post-plus'),
			]
		);
	}
